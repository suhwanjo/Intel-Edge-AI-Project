...
def send_data_to_raspberry_pi(data, raspberry_pi_ip, port=5000):
...
def main(video_path, model_depth_xml_path, model_detection_xml_path, model_traffic_xml_path, raspberry_pi_ip):
                ...
                if bounding_box:
                    ...
                    if depth_value:
                        if depth_value > 50.0:
                            ...
                            send_data_to_raspberry_pi(data, raspberry_pi_ip)
            except queue.Empty:
                pass
...
if __name__ == "__main__":
    video_path = "<http://192.168.0.101:8081>"
    ...
    raspberry_pi_ip = "192.168.0.100"  # 라즈베리파이의 IP 주소
    main(video_path, model_depth_xml_path, model_detection_xml_path, model_traffic_xml_path, raspberry_pi_ip)