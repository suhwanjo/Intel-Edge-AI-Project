...
if __name__ == "__main__":
    video_path = "~/intel_project/MAN_20240621_185159_F.MP4"
    model_depth_xml_path = "~/intel_project/MiDaS_small.xml"
    model_detection_xml_path = "~/intel_project/vehicle-detection-adas-0002.xml"
    model_traffic_xml_path = "~/intel_project/pot2/openvino.xml"
